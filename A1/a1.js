...
function drawPenguin(ctx)
{
  ...
  // Define transformation for eye as a rotation and translation
  /*var eye_offset = [20, 20]; // location of eye relative to head
  var iris_offset = [20, 20]; // location of iris relative to eye
